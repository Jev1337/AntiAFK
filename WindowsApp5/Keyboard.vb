...
#End Region
    ...
    Function LockAll() As Object
        ...
        End If
        If Form1.ComboBox1.SelectedItem Is "CTRL+V" Then
        ...
        End If
        If Form1.ComboBox1.SelectedItem Is "ALT+F4" Then
            ButtonLeftAlt.ForeColor = Color.FromArgb(221, 221, 221)
            ButtonLeftAlt.BackColor = Color.FromArgb(51, 51, 51)
            ButtonLeftAlt.Cursor = Cursors.No
            ButtonLeftAltBlocked = False
            ...
            F4Blocked = False
        End If
        If Form1.ComboBox1.SelectedItem Is "ALT+TAB" Then
            ButtonLeftAlt.ForeColor = Color.FromArgb(221, 221, 221)
            ButtonLeftAlt.BackColor = Color.FromArgb(51, 51, 51)
            ButtonLeftAlt.Cursor = Cursors.No
            ButtonLeftAltBlocked = False
            ...
            ButtonTabBlocked = False
        End If
        If Form1.ComboBox1.SelectedItem Is "ALT+ESC" Then
            ButtonLeftAlt.ForeColor = Color.FromArgb(221, 221, 221)
            ButtonLeftAlt.BackColor = Color.FromArgb(51, 51, 51)
            ButtonLeftAlt.Cursor = Cursors.No
            ButtonLeftAltBlocked = False
    ...
    Private Sub LockAllButton_Click(sender As Object, e As EventArgs) Handles LockAllButton.Click
