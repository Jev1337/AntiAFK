        ...
        Set(ByVal value As String)
            ...
            If My.Computer.FileSystem.FileExists(value) = False Then
                If Form2.CheckBox5.Checked = True Then
                    MessageBox.Show("Failed to locate song! Make sure that the location is correct! Song Disabled.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1)
